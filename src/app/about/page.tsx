...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl">
                <p className="text-4xl font-bold text-teddy-green">Hi, I'm</p>
            ...
            <div>
              ...
              <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                ...
                <p className="text-teddy-green font-semibold text-xl">
      ...
      {/* Stats Section */}
      <section className="py-16 bg-gradient-to-br from-teddy-green to-teddy-gold text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                <div className="text-4xl md:text-5xl font-bold mb-2">{stat.number}</div>
                <div className="text-teddy-green-100 text-sm md:text-base">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
