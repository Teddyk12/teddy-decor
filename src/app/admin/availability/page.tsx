      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
            ...
            <div className="space-y-4">
              {days.map(({ key, label }) => {
                ...
                return (
                  <div key={key} className="flex items-center justify-between p-4 border border-gray-200 rounded-xl hover:border-rose-300 transition-colors">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-xl">
              ...
              <button
                ...
                className="mt-4 flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-rose-500 to-pink-500 text-white font-medium rounded-lg hover:shadow-lg transition-all"
              >
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 px-6 py-4 bg-gradient-to-r from-rose-500 to-pink-500 text-white font-semibold rounded-full hover:shadow-xl hover:scale-105 transition-all"
          >
