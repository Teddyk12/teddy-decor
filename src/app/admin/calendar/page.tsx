...
export default function CalendarPage() {
  ...
  const events = [
    ...
    { date: '2025-12-15', title: 'Sarah Johnson - Wedding', color: 'bg-green-500', guests: 150 },
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
        {/* Calendar Header */}
        <div className="bg-gradient-to-r from-teddy-green to-teddy-gold px-6 py-4">
              ...
              return (
                <div
                  ...
                  className={`aspect-square border-2 rounded-xl p-2 transition-all hover:shadow-md ${
                    isToday
                      ? 'border-teddy-green-500 bg-green-50'
                      : dayEvents.length > 0
                ...
                >
                  <div className={`text-sm font-semibold mb-1 ${
                    isToday ? 'text-teddy-green' : 'text-gray-900'
                  }`}>
                    {day}
                  </div>
