...
export default function HomeImagesPage() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2 flex items-center">
              <Home className="w-8 h-8 mr-3 text-teddy-green" />
              Home Page Editor
            </h1>
      ...
      <div className="bg-white rounded-2xl shadow-sm p-8 mb-8">
        <div className="flex items-center space-x-3 mb-6">
          <div className="p-2 bg-green-100 rounded-lg">
            <Type className="w-6 h-6 text-teddy-green" />
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center space-x-2 px-4 py-2.5 bg-gradient-to-r from-teddy-green to-teddy-gold text-white font-semibold rounded-lg hover:shadow-lg transition-all"
            >
      ...
      {/* Preview Link */}
      <div className="mt-8 p-6 bg-gradient-to-br from-rose-50 to-pink-50 rounded-xl border border-teddy-green-200">
        <div className="flex items-center justify-between">
          <div>
          ...
          <a
            href="/"
            target="_blank"
            className="px-6 py-3 bg-white text-teddy-green font-semibold rounded-full border-2 border-teddy-green-500 hover:bg-green-50 transition-all flex items-center space-x-2"
          >
