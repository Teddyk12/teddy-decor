      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="h-16 flex items-center justify-between px-6 border-b border-gray-200">
              <Link href="/" className="flex items-center">
                <span className="text-2xl font-bold bg-gradient-to-r from-teddy-green to-teddy-gold bg-clip-text text-transparent">
                  Teddy Decor
                </span>
              </Link>
              <button
            ...
            <div className="p-4 border-t border-gray-200">
              <div className="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-gray-100 cursor-pointer mb-2">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-teddy-green to-teddy-gold flex items-center justify-center text-white font-semibold">
                  Y
                </div>
        ...
        <div className="lg:pl-64">
          ...
          <div className="lg:hidden sticky top-0 z-30 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
            ...
            <span className="text-xl font-bold bg-gradient-to-r from-teddy-green to-teddy-gold bg-clip-text text-transparent">
              Teddy Decor
            </span>
