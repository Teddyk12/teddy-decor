...
export default function AdminLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (email === 'admin@teddydecor.com' && password === storedPassword) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-500 to-pink-500 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        {/* Logo */}
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">Teddy Decor</h1>
          <p className="text-rose-100">Admin Dashboard</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full px-6 py-3 bg-gradient-to-r from-rose-500 to-pink-500 text-white font-semibold rounded-full hover:shadow-lg hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="text-center mt-6">
          <Link href="/" className="text-white hover:text-rose-100 transition-colors">
            ← Back to Website
          </Link>
        </div>
      </div>
