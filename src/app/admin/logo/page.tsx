          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg p-8 w-full max-w-md">
            <div className="bg-white rounded-lg shadow-md p-6 flex items-center space-x-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-rose-600 font-medium tracking-wider uppercase">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full px-6 py-4 bg-gradient-to-r from-rose-500 to-pink-500 text-white font-semibold rounded-lg hover:shadow-lg hover:scale-105 transition-all flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
