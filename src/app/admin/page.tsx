...
import { Calendar, Users, Image, Mail, DollarSign, TrendingUp, Clock, CheckCircle } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const quickActions = [
    { label: 'New Booking', icon: Calendar, href: '/admin/bookings/new', color: 'rose' },
    { label: 'Upload to Gallery', icon: Image, href: '/admin/gallery', color: 'purple' },
    { label: 'View Calendar', icon: Calendar, href: '/admin/calendar', color: 'blue' },
    { label: 'Client List', icon: Users, href: '/admin/clients', color: 'green' }
  ];
