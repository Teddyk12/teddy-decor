...
export default function HomePage() {
  const defaultContent = {
    images: {
      heroBackground: 'https://images.unsplash.com/photo-1741969494307-55394e3e4071?q=80&w=2000',
      services: {
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            ...
            unoptimized
          />
          <div className="absolute inset-0 bg-gradient-to-r from-rose-900/60 via-pink-800/40 to-rose-700/30" />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/services"
                className="px-8 py-4 bg-gradient-to-r from-rose-500 to-pink-500 text-white font-semibold rounded-full hover:shadow-2xl hover:scale-105 transition-all text-center"
              >
                View Our Services
              </Link>
              <Link
                href="/gallery"
                className="px-8 py-4 bg-white/10 backdrop-blur-sm text-white font-semibold rounded-full border-2 border-white hover:bg-white hover:text-rose-500 transition-all text-center"
              >
                See Our Gallery
              </Link>
            </div>
              ...
              >
                <div className="relative h-80">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                    ...
                    <div className="flex items-center text-rose-300 font-semibold group-hover:translate-x-2 transition-transform">
