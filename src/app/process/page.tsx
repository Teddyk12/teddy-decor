...
export default function ProcessPage() {
  ...
  return (
    <div className="min-h-screen">
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="relative">
                      <div className="text-8xl md:text-9xl font-bold text-teddy-green-100 absolute -top-8 -left-4 -z-10">
                        {step.number}
                      </div>
                      <div className="relative">
                        ...
                        <ul className="space-y-3">
                          {step.details.map((detail, i) => (
                            <li key={i} className="flex items-start text-gray-600">
                              <span className="text-teddy-green mr-3 mt-1">✓</span>
                              <span>{detail}</span>
                            </li>
                          ))}
                        </ul>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-teddy-green to-teddy-gold text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Ready to Begin Your Journey?
          </h2>
          <p className="text-xl text-teddy-green-50 mb-8">
