          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {decorServices.map((service, index) => {
              ...
              return (
                ...
                >
                  <div className="inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br from-rose-500 to-pink-500 rounded-full mb-6">
                  ...
                  <div className="flex items-center text-rose-600 font-semibold group-hover:translate-x-2 transition-transform mt-4">
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div className="flex-shrink-0">
                      <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-rose-500 to-pink-500 rounded-full">
