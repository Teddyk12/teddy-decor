      ...
      <div className="max-w-3xl w-full">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center space-x-2 mb-4">
            <Sparkles className="w-6 h-6 text-teddy-green animate-pulse" />
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900">
              Thank You, {name}!
            </h1>
            <Sparkles className="w-6 h-6 text-teddy-green animate-pulse" />
          </div>
          <p className="text-2xl text-teddy-green font-semibold mb-2">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 mb-8">
          <div className="text-center mb-8">
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              <span className="font-semibold text-teddy-green">{eventType}</span>!
            </p>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 bg-gradient-to-br from-teddy-green to-teddy-gold rounded-full flex items-center justify-center text-white font-bold">
                    1
                  </div>
                </div>
                <div>
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div className="flex items-center space-x-3 text-gray-600">
                <Mail className="w-5 h-5 text-teddy-green flex-shrink-0" />
                <div>
              ...
              <div className="flex items-center space-x-3 text-gray-600">
                <Calendar className="w-5 h-5 text-teddy-green flex-shrink-0" />
                <div>
        ...
        {/* Contact Info */}
        <div className="bg-gradient-to-br from-teddy-green to-teddy-gold rounded-2xl p-6 text-white text-center mb-8">
          <h3 className="text-xl font-bold mb-3">Need to Reach Us Sooner?</h3>
          <p className="mb-4 text-teddy-green-50">
            We're here to help! Feel free to contact us directly:
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-6">
            <a
              href="tel:+12067392365"
              className="flex items-center space-x-2 hover:text-teddy-green-100 transition-colors"
            >
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/"
            className="inline-flex items-center justify-center px-8 py-4 bg-white text-teddy-green font-semibold rounded-full border-2 border-teddy-green-500 hover:bg-green-50 transition-all"
          >
          ...
          <Link
            href="/gallery"
            className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-teddy-green to-teddy-gold text-white font-semibold rounded-full hover:shadow-xl hover:scale-105 transition-all"
          >
